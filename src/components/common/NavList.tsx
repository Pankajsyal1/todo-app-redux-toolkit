    ...
    <nav>
      <ul className={`flex items-center  ${mobile ? ' flex-col p-4 gap-2' : 'flex-row gap-3'}`}>
        ...
        <li className="md:ms-5">
          <Link className="px-2 py-1 rounded-md text-white text-base font-semibold transition-all duration-200 bg-red-500 hover:bg-red-600 inline-block" to={'/'}>Logout</Link>
        </li>
      </ul>
    </nav>
  );
